...
# Install the following dependencies: sphinxcontrib-restbuilder, sphinx-autodoc-typehints, myst-parser, sphinx-rtd-theme
...
html_theme = 'sphinx_rtd_theme'  # sphinx-rtd-theme
